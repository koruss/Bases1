CREATE OR REPLACE PACKAGE PKG_ADMIN_NATIONALITY  IS
       ...
       PROCEDURE DELETE_NATIONALITIES(PNID_NATIONALITY NUMBER DEFAULT NULL);
...
CREATE OR REPLACE PACKAGE BODY PKG_ADMIN_NATIONALITY IS
       ...
       PROCEDURE DELETE_NATIONALITIES(pnId_Nationality IN NUMBER DEFAULT NULL) AS
         vmError exception;
         begin

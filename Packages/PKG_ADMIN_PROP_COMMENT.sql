CREATE OR REPLACE PACKAGE PKG_ADMIN_PROP_COMMENT  IS
       ...
       PROCEDURE SET_ID_COMMENT(PNID_COMMENT NUMBER, NEW_VALUE NUMBER);
...
END PKG_ADMIN_PROP_COMMENT;



CREATE OR REPLACE PACKAGE BODY PKG_ADMIN_PROP_COMMENT IS
       ...
       PROCEDURE SET_ID_COMMENT(PNID_COMMENT NUMBER, NEW_VALUE NUMBER) IS
         VMENERROR                           EXCEPTION;
         BEGIN
             UPDATE Proposal_comment SET ID_COMMENT= NEW_VALUE WHERE ID_COMMENT=PNID_COMMENT;     

CREATE OR REPLACE PACKAGE PKG_ADMIN_COMMUNITY  IS
       FUNCTION GET_ID_COMMUNITY(PNCOMMUNITY_NAME IN VARCHAR2,PNIDCANTON IN NUMBER DEFAULT NULL)  RETURN NUMBER;
...
CREATE OR REPLACE PACKAGE BODY PKG_ADMIN_COMMUNITY IS
        ...
        FUNCTION GET_ID_COMMUNITY(PNCOMMUNITY_NAME IN VARCHAR2,PNIDCANTON IN NUMBER DEFAULT NULL)  RETURN NUMBER
         ...
         BEGIN
                  ...
                  INTO VNID_COMMUNITY
                  FROM COMMUNITY
                  WHERE COMMUNITY_NAME=PNCOMMUNITY_NAME AND ID_CANTON=NVL(PNIDCANTON,ID_CANTON);
      ...
      PROCEDURE GET_ALL_COMMUNITY(PRECORDSET OUT SYS_REFCURSOR, PNID_COMMUNITY IN number default null) AS
       ...
       BEGIN
              ...
              SELECT COMMUNITY_NAME
              FROM COMMUNITY
              WHERE ID_CANTON = NVL(PNID_COMMUNITY, ID_CANTON);
